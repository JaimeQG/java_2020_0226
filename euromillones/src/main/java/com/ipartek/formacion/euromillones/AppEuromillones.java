package com.ipartek.formacion.euromillones;
...
import com.ipartek.formacion.euromillones.controladores.Configuracion;
import com.ipartek.formacion.euromillones.modelos.Sorteo;

public class AppEuromillones {
	...
	static final private int NUMERO_MAX_ESTRELLA = 50;
	...
	private static Dao<Sorteo> dao = Configuracion.daoEuromillones;
	...
	private static void crear() {
		...
		try {
			Sorteo sorteo = dao.crearYObtener(new Sorteo(null, String.valueOf(numeros[0]), String.valueOf(numeros[1]),
