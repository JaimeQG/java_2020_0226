...
public class ProductoController {
	@GetMapping
	public String getProducto(Producto producto) { // Al hacer th:field= en el template producto.html hay que pasar un
													// objeto producto
		return "producto"; // Nombre de la vista/template
	}
