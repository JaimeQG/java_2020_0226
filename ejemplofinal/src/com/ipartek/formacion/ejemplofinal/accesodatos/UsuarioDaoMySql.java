...
/**
 * Implementación con jdbc/mySql del DAO para el objeto Usuario
 * 
...
public class UsuarioDaoMySql implements DaoUsuario {
	...
	public Usuario obtenerPorEmail(String email) {
		try (Connection con = Config.dataSource.getConnection();
			...
			if (rs.next()) {
				cliente = new Cliente(rs.getLong("c.id"), rs.getString("c.nombre"), rs.getString("c.apellidos"),
						rs.getString("c.cif"), rs.getDate("c.fecha_nacimiento").toLocalDate(), null);
